package com.As13.expansion.client.entity;
...
public class EndPig extends EndAnimals implements ItemSteerable, Saddleable{
    private static final EntityDataAccessor<Boolean> DATA_SADDLE_ID = SynchedEntityData.defineId(EndPig.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Integer> DATA_BOOST_TIME = SynchedEntityData.defineId(EndPig.class, EntityDataSerializers.INT);
    private static final Ingredient FOOD_ITEMS = Ingredient.of(Items.CHORUS_FRUIT);
    private final ItemBasedSteering steering = new ItemBasedSteering(this.entityData, DATA_BOOST_TIME, DATA_SADDLE_ID);

    public EndPig(EntityType<? extends Animal> p_27557_, Level p_27558_) {
    ...
    public EndPig getBreedOffspring(ServerLevel p_149001_, AgeableMob p_149002_) {
        return BkEntityTypes.END_PIG.get().create(p_149001_);
    }
