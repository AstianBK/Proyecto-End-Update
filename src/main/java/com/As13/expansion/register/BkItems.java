...
import com.As13.expasion.item.PilkBucketItem;
    ...
    public static final RegistryObject<Item> PILK = ITEMS.register("pilk",()->new PilkBucketItem(
            new Item.Properties()
                    .food(new FoodProperties.Builder()
                            .effect(()->new MobEffectInstance(com.As13.expasion.register.BkEffect.PURPLE_COAT.get(),160,0),1.0F).build()).tab(CreativeModeTab.TAB_FOOD)));
