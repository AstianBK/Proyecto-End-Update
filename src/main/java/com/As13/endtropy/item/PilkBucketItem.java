package com.As13.endtropy.item;
...
public class PilkBucketItem extends Item {
    private static final int DRINK_DURATION = 32;

    public PilkBucketItem(Item.Properties p_42921_) {
        super(p_42921_);
    }
    ...
    public ItemStack finishUsingItem(ItemStack p_42923_, Level p_42924_, LivingEntity p_42925_) {
        ...
        if (p_42925_ instanceof ServerPlayer serverplayer) {
            ...
            serverplayer.addEffect(new MobEffectInstance(BkEffect.PURPLE_COAT.get(),160,0));
        }
