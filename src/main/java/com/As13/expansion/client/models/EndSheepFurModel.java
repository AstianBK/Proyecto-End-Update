package com.As13.expansion.client.models;
...
public class EndSheepFurModel<T extends EndSheep> extends QuadrupedModel<T>{
    private float headXRot;

    public EndSheepFurModel(ModelPart p_170903_) {
