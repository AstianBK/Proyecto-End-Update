package com.As13.expansion.client.layers;

import com.As13.expansion.client.entity.EndSheep;
import com.As13.expansion.client.models.EndSheepFurModel;
...
public class EndSheepFurLayer extends RenderLayer<EndSheep, EndSheepModel<EndSheep>> {
    private static final ResourceLocation SHEEP_FUR_LOCATION = new ResourceLocation("textures/entity/sheep/sheep_fur.png");
    private final EndSheepFurModel<EndSheep> model;

    public EndSheepFurLayer(RenderLayerParent<EndSheep, EndSheepModel<EndSheep>> p_174533_, EntityModelSet p_174534_) {
        super(p_174533_);
        this.model = new EndSheepFurModel<>(p_174534_.bakeLayer(ModelLayers.SHEEP_FUR));
    }

    public void render(PoseStack p_117421_, MultiBufferSource p_117422_, int p_117423_, EndSheep p_117424_, float p_117425_, float p_117426_, float p_117427_, float p_117428_, float p_117429_, float p_117430_) {
