...
public class EndSheep extends EndAnimals implements Shearable, net.minecraftforge.common.IForgeShearable {
    ...
    public static DyeColor getRandomSheepColor(RandomSource p_218262_) {
        ...
        if (i < 5) {
            ...
            return p_218262_.nextInt(500) == 0 ? DyeColor.PINK : DyeColor.PURPLE;
        }
    }

    public EndSheep getBreedOffspring(ServerLevel p_149044_, AgeableMob p_149045_) {
        EndSheep sheep = (EndSheep)p_149045_;
        EndSheep sheep1 = BkEntityTypes.END_SHEEP.get().create(p_149044_);
